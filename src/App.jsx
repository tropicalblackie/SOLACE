...
export default function DashboardSolace() {
  ...
  const ASTRONAUTI = [
    ...
    { id: 2, nome: "Lin Meiyun", ruolo: "Medico", stato: "Eccellente", fc: 68, pressione: "115/74", o2: 99, stress: 18, sonno: 7.1, energia: 92, ritmo: "Picco 05:30-09:30", muscoli: "Eccellente", immunita: "Eccellente" },
  ...
  const AVVISI = [
    ...
    { tipo: "info", titolo: "Lin Meiyun: Picco Performance", descrizione: "Condizioni ottimali. Finestra critica 05:30-09:30.", azione: "Assegnare Task" },
  ...
  const RACCOMANDAZIONI = [
    ...
    { tipo: "info", text: "Lin Meiyun al picco biologico. Operazioni critiche: 05:30-09:30." },
